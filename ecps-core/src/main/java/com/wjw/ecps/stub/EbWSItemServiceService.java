 ...
 * 2019-02-10T20:12:39.520+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWSItemServiceService", 
                  wsdlLocation = "http://localhost:8090/ecps-portal/services/publishItem?wsdl",
                  targetNamespace = "http://service.ecps.wjw.com/") 
public class EbWSItemServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.ecps.wjw.com/", "EbWSItemServiceService");
    public final static QName EbWSItemServicePort = new QName("http://service.ecps.wjw.com/", "EbWSItemServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8090/ecps-portal/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWSItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8090/ecps-portal/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
