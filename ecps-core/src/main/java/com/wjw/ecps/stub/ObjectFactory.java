 ...
 * generated in the com.wjw.ecps.stua package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ecps.wjw.com/", "publishItemResponse");
    private final static QName _PublishItem_QNAME = new QName("http://service.ecps.wjw.com/", "publishItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wjw.ecps.stua
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ecps.wjw.com/", name = "publishItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ecps.wjw.com/", name = "publishItem")
