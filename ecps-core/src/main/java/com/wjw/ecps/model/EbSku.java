...
public class EbSku {
    ...
    private List<EbSpecValue>ebSpecValues;
	...
	public List<EbSpecValue> getEbSpecValues() {
		return ebSpecValues;
	}

	public void setEbSpecValues(List<EbSpecValue> ebSpecValues) {
		this.ebSpecValues = ebSpecValues;
	}
