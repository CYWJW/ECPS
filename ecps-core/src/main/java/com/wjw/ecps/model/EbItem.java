...
public class EbItem {
	...
	private List<EbParaValue> ebParaValues;
	...
	public List<EbParaValue> getEbParaValues() {
		return ebParaValues;
	}

	public void setEbParaValues(List<EbParaValue> ebParaValues) {
		this.ebParaValues = ebParaValues;
	}
