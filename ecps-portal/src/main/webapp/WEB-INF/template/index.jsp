...
<link rel="search" type="application/opensearchdescription+xml"
	href="${path}/opensearch.xml" title="移动购物" />
...
<script type="text/javascript" src="${path}/res/js/index/index.js"></script>
</head>
<body>
	...
	<div class="w loc">
		...
		<p class="l">
			...
			<samp>|</samp>
			<a href="${path}/user/login/index.do" title="我的商城">我的商城</a>
		</p>
		...
		<p class="r">
			<a href="index.html" title="商城首页">商城首页</a>
			<samp>&gt;</samp>
			<span class="gray">手机商城</span>
		</p>
	...
	<div class="w ofc mt">
		<div class="l wl">
			...
			<h2 class="h2 h2_l">
				<em title="商品分类">商品分类</em><cite></cite>
			</h2>
			<div class="box bg_gray">
				<ul class="ul left_nav">
					<li><a href="#" title="网上选号"><img
							src="${path}/res/img/gray/ln01.gif" alt="网上选号" />网上选号</a></li>
					<li><a href="#" title="手机商城"><img
							src="${path}/res/img/gray/ln02.gif" alt="手机商城" />手机商城</a></li>
					<li><a href="#" title="优惠活动"><img
							src="${path}/res/img/gray/ln03.gif" alt="优惠活动" />优惠活动</a></li>
				</ul>
			</div>
			...
			<div class="box bg_white">
				<ul class="uls x_50x50">
					<li><var class="sfont">1</var> <a href="#" title="张同来"
						target="_blank" class="pic"><img
							src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
						<dl>
							<!-- dt 8个文字+${path}. -->
							<dt>
								<a href="#" title="摩托罗拉XT319" target="_blank">摩托罗拉摩托罗拉拉${path}.</a>
							</dt>
							<dd class="orange">￥3599 ~ ￥4599</dd>
						</dl></li>
					<li><var class="sfont">2</var> <a href="#" title="张同来"
						target="_blank" class="pic"><img
							src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
						<dl>
							<dt>
								<a href="#" title="摩托罗拉XT319" target="_blank">摩托罗拉XT319</a>
							</dt>
							<dd class="orange">￥3599 ~ ￥4599</dd>
						</dl></li>
					<li><var class="sfont">3</var> <a href="#" title="张同来"
						target="_blank" class="pic"><img
							src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
						<dl>
							<dt>
					...
					<li><a href="#" title="张同来" target="_blank" class="pic"><img
							src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
						<dl>
							<dt>
								<a href="#" title="摩托罗拉XT319" target="_blank">摩托罗拉XT319</a>
			...
			<div class="ad200x75 mt">
				<img src="${path}/res/img/pic/ad200x75.jpg" alt="" />
			</div>

			<div class="ad200x169 mt">
				<img src="${path}/res/img/pic/ad200x169.jpg" alt="" />
			</div>

			<div class="ad200x244 mt">
				<img src="${path}/res/img/pic/ad200x244.jpg" alt="" />
			</div>
		...
		<div class="r wr">
			...
			<h2 class="h2 h2_r rel">
				<samp></samp>
				<em title="热卖手机">&nbsp;&nbsp;&nbsp;热卖手机</em><cite><a href="#"
					title="更多热卖手机" class="more">更多&gt;&gt;</a></cite>
			</h2>
			<div class="box bg_white">
				<ul class="uls i_150x150 x4_150x150">
					<li><a href="./productDetail.jsp" title="张同来" target="_blank"
						class="pic"><img src="${path}/res/img/pic/p140X140b.png"
							alt="摩托罗拉XT319" /></a>
						<dl>
							<!-- dt 10个文字+${path}. -->
							<dt>
								<a href="/productDetail.jsp" title="摩托罗拉XT319" target="_blank">摩托罗拉摩托罗拉摩托${path}.</a>
							</dt>
							<!-- dt 25个文字+${path}. -->
							<dd class="h40">手手机下单就返下单就返新品上市上手手机下单就就${path}.</dd>
							<dd class="orange">￥3599 ~ ￥4599</dd>
							<dd>
								<a href="./productDetail.jsp" title="购买裸机"
									class="inb btn70x21 mr">购买裸机</a><a href="./productDetail.jsp"
									title="优惠购机" class="inb btn70x21">优惠购机</a>
							</dd>
						</dl> <img src="${path}/res/img/pic/hot.gif" alt="热门" class="type" />
					</li>
					<li><a href="./productDetail.jsp" title="张同来" target="_blank"
						class="pic"><img src="${path}/res/img/pic/p140X140b.png"
							alt="摩托罗拉XT319" /></a>
						<dl>
							<dt>
								<a href="./productDetail.jsp" title="摩托罗拉XT319" target="_blank">摩托罗拉XT319</a>
							</dt>
			...
			<h2 class="h2 h2_filter mt">
				<em title="手机商品筛选">手机&nbsp;-&nbsp;商品筛选</em><cite><a
					href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite>
			</h2>
			...
			<ul class="uls filter">
				<li><label>您已选择：</label>
				<p class="sel">
						<a href="javascript:void(0);"><em>归属地：</em>贵阳<cite
							title="关闭此筛选条件">X</cite></a> <a href="javascript:void(0);"><em>品牌：</em>动感地带<cite
							title="关闭此筛选条件">X</cite></a>
					</p></li>
				<li><b>价格：</b>
				
				<p>
						<a href="javascript:void(0);" fValue="" fType="price" class="here">不限</a> <a
							href="javascript:void(0);" fValue="1-499" fType="price">1-499</a> <a
							href="javascript:void(0);" fValue="500-999" fType="price">500-999</a> <a
							href="javascript:void(0);" fValue="1000-1999" fType="price">1000-1999</a> <a
							href="javascript:void(0);" fValue="2000-2999" fType="price">2000-2999</a> <a
							href="javascript:void(0);" fValue="3000-3999" fType="price">3000-3999</a> <a
							href="javascript:void(0);" fValue="4000-4999" fType="price">4000-4999</a> <a
							href="javascript:void(0);" fValue="5000-1000000" fType="price">5000以上</a>
					</p></li>
				<li><b>品牌：</b>
				<p>
						<a href="javascript:void(0);" fValue="" fType="brandName" class="here">不限</a>
						<c:forEach items="${ebd }" var="ed">
							<a href="javascript:void(0);" fValue="${ed.brandId}" fType="brandId">${ed.brandName}</a>
						</c:forEach>
					</p></li>
				<li><b>商品搜索：</b>
				<p>
				...
				<c:forEach items="${ebf }" var="ef">
				<li style="display: none"><b>${ef.featureName}：</b>
				<p>
				<a href="javascript:void(0);" fValue="" fType="featValues" class="here">不限</a> 
				
				<c:forEach items="${ef.selectValues}" var="val">
						<a href="javascript:void(0);"  fValue="${val}" fType="featValues">${val}</a> 
				</c:forEach>
					</p></li>
				</c:forEach>
				
				<li class="line"></li>
				<li class="alg_c after"><a href="javascript:void(0);"
					title="高级搜索" class="btn80x22 open">高级搜索</a></li>
			</ul>

			<iframe id="itemListIframe" src="${path}/item/phoneClassification.do"
		...
		<div class="cont">
			<ul class="uls form">
				...
				<li><label for="captcha">验 证 码：</label> <span
					...
					src="${path}/res/img/pic/code.png" /><a href="#"
