...
<script src="${path}/res/js/passport/login.js"></script>
<script type="text/javascript">
	...
	<div class="r">
		...
		<form id="jvForm" action="${path}/user/login.do" method="post">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img src="${path}/user/getImage.do" id="getImage" onclick="changeImgs()" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="changeImgs()" title="换一张">换一张</a></li>
			<li class="gray"><label for="">&nbsp;</label><input type="checkbox" name="" />30天内免登录（公共电脑勿用）</li>
			<li><label for="">&nbsp;</label><input type="submit" id="submit" value="登 录" class="hand btn66x23"/><a href="#" title="忘记密码？">忘记密码？</a></li>
